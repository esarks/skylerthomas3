#!/usr/bin/env python3
"""
Remove duplicates AND sort menu alphabetically
"""
...
OUTPUT_FILE = Path('/Users/paulmarshall/Documents/GitHub/skylerthomas3/Menu-Clean-Sorted-Alphabetically.xml')
...
def main():
    ...
    print(f"\nFinal menu order (no duplicates):")
    ...
    print("✓ Done!")
    print(f"\nCreated clean, sorted menu with:")

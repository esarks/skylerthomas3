#!/usr/bin/env python3
"""
Extract songs from posts in MENU order
"""
...
def get_menu_order():
    ...
    print(f"Found {len(menu_items)} posts in menu")
    return [item['object_id'] for item in menu_items]
...
def main():
    print("=" * 60)
    print("AudioIgniter - Songs in MENU Order")
    print("=" * 60)
